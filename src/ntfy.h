...
// Subscribes to a ntfy.sh topic and forwards incoming messages to the
// bulldog. Anyone with the topic URL can send from anywhere on the
// internet — no port forwarding, no account.
//
